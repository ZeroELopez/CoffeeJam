...
[RequireComponent(typeof(ExploderenemyAI))]
public class ExplosionEnemyEtry : Entity, ISubscribable<PlayerPowerUpStart>, ISubscribable<PlayerPowerUpEnd>
{
    ...
    {
        GetComponent<ExploderenemyAI>().speed /= 2;
    }
